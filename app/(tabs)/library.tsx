...
//   const { podcasts, loading, reload, createPodcast } = useLibrary();
//   const router = useRouter();

//   const handleCreate = async () => {
//     const test = await createPodcast({
//       title: 'Test Podcast',
//       fileUri: 'https://archive.org/download/testmp3testfile/mpthreetest.mp3',
//       duration: 60,
//     });
...
//   return (
//     <View style={{ flex: 1 }}>
//       <Button title="➕ Add Test Podcast" onPress={handleCreate} />
